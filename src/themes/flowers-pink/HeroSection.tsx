...
export default function HeroSection() {
    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#fdfaf9] text-[#3a3f38]">
            {/* Desktop background */}
            <div className="absolute inset-0 hidden md:block bg-[url('/flowers-pink-bg.png')] bg-cover bg-center bg-no-repeat pointer-events-none" />
            {/* Mobile background */}
            <div className="absolute inset-0 block md:hidden bg-[url('/mobile-hero.png')] bg-cover bg-top bg-no-repeat pointer-events-none" />
