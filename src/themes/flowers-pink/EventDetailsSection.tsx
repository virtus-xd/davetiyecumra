...
export default function EventDetailsSection() {
    ...
    // Düğün konumları: Düğün Salonu, Kız Evi, Erkek Evi
        ...
        <section ref={sectionRef} className="py-24 px-4 bg-[#fdfaf9] text-[#3a3f38] relative overflow-hidden">
            <div className="max-w-5xl mx-auto relative z-10">
                <div className={`text-center mb-20 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
                    <h2 className="font-serif text-4xl md:text-5xl text-[#4b5c51] mb-6">Düğün Detayları</h2>
                ...
                <LocationCarousel locations={weddingLocations} isVisible={isVisible} />
            </div>
        </section>
    );
}
